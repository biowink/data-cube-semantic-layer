...
SELECT 
  ...
  started_at, backend_created_at, backend_updated_at, expires_at, platform,
...
--  SELECT
--      platform,
--     --  renewed_after_30_days,
--      is_in_intro_offer_period,
--      count(CASE WHEN crossgrade is true THEN subscription_id ELSE null END) as crossgrade_reactivations,
--      count(CASE WHEN crossgrade is false THEN subscription_id ELSE null END) as non_crossgrade_reactivations
