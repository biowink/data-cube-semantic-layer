        ...
        trials AS (
          ...
          WHERE
            ...
            AND CURRENT_DATE - trial_started_at::DATE BETWEEN 9 AND 69
            AND NOT is_in_intro_offer_period
            AND advertising_id is null
        ),
        trial_sessions AS (
      ...
      SELECT
          ...
          AVG(CASE WHEN purchases.backend_created_at::DATE - trial_started_at::DATE BETWEEN 0 AND 14 THEN 1::FLOAT ELSE 0 END) * 100 AS trial_conversion_rate
        FROM trials
