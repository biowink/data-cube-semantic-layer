-- did users in the test group have more tracking sessions during their first week?

WITH raw_sessions AS (
    SELECT
        master_id,
        COUNT(DISTINCT session_index) as sessions
    ...
    WHERE derived_tstamp >= '2022-05-19'
        ...
        AND derived_tstamp <= sp_users.first_seen + '7 days'::interval
    GROUP BY 1
),
