...
SELECT (DATEDIFF('month', started_dt, expired_dt) - 1)/3 + 1 AS subscribed_length,
       month_offset,
...
WHERE DATE_TRUNC('month', expired_dt) BETWEEN '2021-06-01' AND '2022-04-01'
GROUP BY 1, 2
HAVING subscribed_length BETWEEN 1 AND 8
ORDER BY 1, 2
;