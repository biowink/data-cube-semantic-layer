SELECT
    ...
    AVG(CASE WHEN count_m2_sessions > 0 THEN count_m2_sessions * 1.0/30 END) AS m2_dau_mau,
    ...
    AVG(CASE WHEN DATE_DIFF('year', birthday, account_created_at) < 20 THEN 1.0 
        WHEN DATE_DIFF('year', birthday, account_created_at) >= 20 THEN 0 END) AS share_teenager
