...
reactivation_timestamp AS (
    ...
    WHERE subscriptions_events.subscription_type in ('Subscription Purchased', 'Subscription Renewed')
      AND subscriptions_events.backend_created_at >= cancellations.cancellation_expires_at
      AND subscriptions_events.backend_created_at >= cancellations.cancellation_backend_created_at
