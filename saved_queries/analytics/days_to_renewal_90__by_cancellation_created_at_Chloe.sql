...
SELECT DATE_TRUNC('week', cancellation_backend_created_at) AS week_created_at, subscription_duration, COUNT(DISTINCT subscription_id)
FROM reactivations
WHERE days_to_renewal IN (90,91,92)
GROUP BY 1, 2