SELECT derived_tstamp::DATE AS date,
       ...
       SUM(CASE WHEN mobile_event_name = 'View Subscription Plans' THEN 1 END) AS subscription_plan_views,
       SUM(CASE WHEN mobile_event_name = 'Subscription Started' THEN 1 END) AS subscriptions_started,
